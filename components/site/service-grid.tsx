          ...
          <article className="border border-border bg-background p-6">
            <div className="flex items-start justify-between gap-6">
              <div className="space-y-4">
                <div className="inline-flex size-12 items-center justify-center rounded-full bg-secondary text-foreground">
                ...
                <div>
                  ...
                  <p
                    className={cn(
                      "mt-3 max-w-xl text-base text-muted-foreground",
                      compact ? "line-clamp-3" : "leading-7"
                    )}
                  >
                    {service.description}
                  </p>
